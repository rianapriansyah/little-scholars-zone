...
export function ChildManageDialog({ open, child, onClose, onSaved }: Props) {
    ...
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
      ...
      <DialogContent dividers>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          />
          <TextField size="small" label="Notes" value={notes} onChange={(e) => setNotes(e.target.value)} multiline minRows={3} fullWidth />
